...
if(isset($_SESSION['standby'])){
	...
	?>
		<style type="text/css">
			...
			.loading__dots__dot {background-color: #ffffff; width: 20px; height: 20px; border-radius: 50%; margin: 0 5px; color: #587B7F; } 
	...
	<div class="loading" style="margin-top: 11%;">
		...
		<div class="loading__msg">
			<center>
				...
				<br><br>
			Lithium Networks is currently checking your brower to ensure you are not a robot.</div>
	</div>
