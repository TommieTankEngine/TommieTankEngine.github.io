<style type="text/css">
	...
	nav{background:black url(/alerticon.png) left no-repeat; background-position: 15px; color: white; text-align:center; position: fixed; top:30%; left:0; width: 100%; } 
...
<nav>
	<center>
		...
		<form method="post" name="<?=$nom_form; ?>">
			...
			<input type="text" name="valCAPTCHA" class="code" placeholder="Enter the code above.">
